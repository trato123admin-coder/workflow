...
| `20260925120000_fix_persons_rls_unassigned.sql` | 2026-09-25 | Staging (Cloud) | Verificado OK | Actualización de `private.can_access_person` para permitir lectura de personas de directorio sin casos asociados a usuarios con `clients.read`. |
