...
| `20260924120000_settings_and_catalogs.sql` | — | Pendiente Staging | Escrito / Pendiente | Catálogos, flags, settings, historial inmutable, custom fields, holidays y RLS settings.manage. |
| `20260924130000_settings_seeds.sql` | — | Pendiente Staging | Escrito / Pendiente | Semillas de 23 catálogos, 28 flags, 39 definiciones y parámetros por defecto. |
